...
LUAI_FUNC void luaK_posfix (FuncState *fs, BinOpr op, expdesc *v1,
                            expdesc *v2, int line);
LUAI_FUNC void luaK_pipe (FuncState *fs, expdesc *e1, expdesc *e2);
LUAI_FUNC void luaK_revpipe (FuncState *fs, expdesc *e1, expdesc *e2);
LUAI_FUNC void luaK_safepipe (FuncState *fs, expdesc *e1, expdesc *e2);
LUAI_FUNC void luaK_pipe_call (FuncState *fs, expdesc *pipe_arg, int func_reg, 
                               int nargs, int placeholder_pos);
LUAI_FUNC void luaK_condexp (FuncState *fs, expdesc *v1, expdesc *v2, expdesc *v3);
LUAI_FUNC void luaK_interpstring (LexState *ls, expdesc *v);
