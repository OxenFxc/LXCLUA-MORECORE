...
-- 示例: lua compile_cff.lua test.lua test.luac 15   -- 全开混淆

local input_file = arg[1] or "test_cff_demo.lua"
local output_file = arg[2] or "test_cff_demo.luac"
local obf_flags = tonumber(arg[3]) or 1  -- 默认仅CFF
