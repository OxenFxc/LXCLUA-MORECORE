...
enum RESERVED {
  ...
  TK_DO, TK_ELSE, TK_ELSEIF, TK_END, TK_ENUM, TK_FALSE, TK_FINALLY, TK_FOR, TK_FUNCTION,
  TK_GLOBAL, TK_GOTO, TK_IF, TK_IN, TK_IS, TK_LAMBDA, TK_LOCAL, TK_NIL, TK_NOT, TK_OR,
  TK_REPEAT,
